...
public class UsersManager extends BaseManager<User, UserException> {
    ...
    @Override
    public User getOne(int id) throws SQLException, UserException {
        try (Connection c = database.getConnection()) {
    ...
    @Override
    public void insert(User user) throws SQLException, DatabaseException {
        try (Connection c = database.getConnection()) {
